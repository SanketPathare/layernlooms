...
export default function ContactForm() {
    ...
    return (
        <div className="rounded-2xl border p-6 sm:p-8 flex flex-col gap-5 transition-colors duration-300 bg-white border-zinc-200">
            {/* Name + Email */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        className={`w-full border rounded-xl px-4 pt-6 pb-3 text-sm appearance-none cursor-pointer outline-none transition-all duration-150 bg-zinc-100 text-black ${focused === "projectType" ? "border-black" : "border-zinc-200 hover:border-zinc-400"}`}
                    >
                    ...
                    <svg
                        className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none text-zinc-400"
            ...
            <div className="relative">
                ...
                <textarea
                    ...
                    onBlur={() => setFocused(null)}
                    className={`w-full border rounded-xl px-4 pt-8 pb-3 text-sm resize-none outline-none transition-all duration-150 bg-zinc-100 text-black ${focused === "message" ? "border-black" : "border-zinc-200 hover:border-zinc-400"}`}
                />
            </div>
            ...
            <p className="text-center text-xs transition-colors duration-300 text-zinc-400">
